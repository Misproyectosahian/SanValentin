  ...
  <div className="envelope-container">
    <div className="envelope">
      ...
      <div className="envelope-labels">
        <span className="from-label">De: Julian</span>
        <span className="to-label">Para: Amadaluci</span>
      </div>
    </div>
  </div>
</motion.div>
          ...
          <div className="article-section">
            ...
            <div className="article-content">
              <div className="article-text">
                <p>Después de que el mundo hiciera su magia y los caminos se cruzaran, quedó claro algo: quiero vivir este 14 de febrero contigo. Mi corazón —la única fuente confiable en estos temas— lo tiene claro desde hace tiempo.</p>
                
                <p>Quiero un San Valentín a tu lado, lleno de amor, risas sinceras y momentos que se queden grabados.</p>
              </div>
              ...
              <div className="article-image">
                <div className="image-placeholder">
                  <div className="couple-illustration">
                    👫<br/>
                    <span className="mini-hearts">💕💗💖</span>
                  </div>
                </div>
              ...
              >
                <div className="locket-outer">
                  <div className="locket-inner">
                    ...
                    <span className="locket-letter right">J</span>
                  </div>
                </div>
              </motion.div>
            </motion.div>
